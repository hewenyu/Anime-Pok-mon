...
const HistoryModal: React.FC<HistoryModalProps> = ({
  ...
  return (
    <div
      className="history-modal-overlay modal-overlay-base"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        className="history-modal-content modal-content-base"
        onClick={e => e.stopPropagation()}
      >
        <div className="history-modal-header modal-header-base">
          <h2 id="historyModalTitle" className="text-xl font-bold">
            对话历史
          </h2>{' '}
          {/* Specific color already applied by .history-modal-header h2 */}
          <button
            onClick={onClose}
            className="history-modal-close-button modal-close-button-base"
            aria-label="关闭历史记录"
          >
            &times;
          </button>
